...
\begin{enumerate}
    ...
    \item \textbf{Structured workflows}: An orchestrator agent and approval-gate system for controlled development processes (PRD → Architecture → Design → Implementation → Review).
