...
3. **Generate installation scripts** (`scripts/install-context7-skills.sh` and `.ps1`) that can be committed to your repo
4. **Generate installation commands** customized for your project
5. **Group skills** into Essential (directly detected) and Optional (complementary)

### Installation Scripts (Recommended)

The agent-generator creates installation scripts that your entire team can use:
...
**Generated Files:**
- `scripts/install-context7-skills.sh` (Unix/Linux/macOS)
- `scripts/install-context7-skills.ps1` (Windows PowerShell)
...
```bash
# Unix/Linux/macOS developers
./scripts/install-context7-skills.sh

# Windows PowerShell developers
.\scripts\install-context7-skills.ps1
```
