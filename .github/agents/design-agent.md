...
2. Route to `@architecture-agent` for domain expert review (alignment):
...
4. Route to `@test-design-agent` for domain expert review (testability):
...
6. Route to `@review-agent` for quality review:
