...
| **shareable-package-agent** | `pyproject.toml` OR `setup.py` OR `package.json` at repo root; or handoff from design-agent when design specifies publishable package |
